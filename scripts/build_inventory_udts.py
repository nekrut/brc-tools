...
requirements:
  ...
  #
  # ⚠ ZERO HEADROOM, MEASURED 2026-09-21. The 219-assembly run peaked at 32.00 GiB against a
  # 32 GiB grant (27.81 GiB on the run before it). It has not failed, but it cannot absorb more
  # panel members. Raising this needs a measurement, not a guess, so it is left at 32 GiB and
  # flagged here rather than quietly bumped.
  - type: resource
    cores_min: 16
    ram_min: 32768
shell_command: |
